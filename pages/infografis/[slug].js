import DetailComponents from "../../src/components/pages/detailInfografis";

const InfografisDetail = ({ data, infografis, terpopuler }) => <DetailComponents data={data} infografis={infografis} terpopuler={terpopuler} />

export async function getServerSideProps(ctx) {
  const slug = ctx.query.slug

  const response = await fetch(`${process.env.URL}/api/portal/infografis/detail/${slug}`)
